			...
			<div class="contents_sub">
				...
				<div class="board_view">
					<table>
						<tr>
							<th width="10%">제목</th>
							<td width="60%">[공지]필독사항입니다.</td>
							<th width="10%">등록일</th>
							<td width="20%">2022-08-01</td>
						</tr>
						<tr>
							<th>글쓴이</th>
							<td>관리자</td>
						...
						<tr>
							<td colspan="4" height="400" valign="top"
								...
								<p>췍! 췍! 암더 코리안 탑클래스 힙합모범 노블레스 페뷸러스 터뷸렌스 고져스 벗 댕저러스 난 비트를
									비틀어 제껴버리는 셔브미션 챔피욘 똑바로 눈떠라 떠나면 잡지 못할 버스에 불을 지폈어 싄의 흐름에 부름에 답해
									풋잇백 킬리만자로의 표범 거만해 계속해 말해 나만의 기술</p>
								<br /> 장문복 가사였음
							</td>
						</tr>
					</table>
				...
				<div class="btn_area">
					<div class="align_left">
						<input type="button" value="목록" class="btn_list btn_txt02"
							style="cursor: pointer;" onclick="location.href='adminnotice.do'" />
					</div>
					
					<div class="align_right">
						<input type="button" value="수정" class="btn_list btn_txt02"	style="cursor: pointer;"
						onclick="location.href='adminnotice_modify.do'" /> 
						...
						onclick="location.href='adminnotice_write.do'" />
					</div>
				</div>
				<!--//게시판-->
			</div>
