...
<body>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	<div id="wrap">
		<div class="con_txt">
			<form action="./adminnotice_writeok.do" method="post" name="wfrm" enctype="multipart/form-data">
						...
						<div class="btn_area">
							<div class="align_left">
								<input type="button" value="목록" class="btn_list btn_txt02"
									...
									onclick="location.href='adminnotice.do?cpage=<%=cpage %>'" />
							</div>
