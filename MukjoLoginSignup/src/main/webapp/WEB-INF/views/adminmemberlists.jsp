       ...
       for (int j=0; j<memberLists.size(); j=j+20) {
          ...
          for (int i=j; i<j+20; i++) {
             ...
             if (i>=memberLists.size()) {
                ...
                sbHtml.append("<td><a href='../admin/members/del?seq="+seq+"&name="+name+"'><button type='sumbit'>추방</button></a></td>");
                }
                sbHtml.append("</tr>");
                num+=1;
             }
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
      ...
      <section id="locationSec">
        <div id = "locationwrap">
             ...
             <button class="active"><a href="../admin/members" style="color: #de5f47">전체 회원 목록</a></button>
    ...
    <div id="wrap">
       ...
       <section id ="btnSec" >
            ...
            <form action="../../admin/members" method="post" name="sfrm">          
...
<%   
   if (startBlock==1) { //<<
      ...
      out.println("<span><a href='../../admin/members?cpage="+(startBlock-blockPerPage)+"'>&lt;&lt;</a>&nbsp;&nbsp;</span>");
   }
   ...
   for (int i=startBlock;i<=endBlock;i++) {
      if (cpage==i) {
         ...
         out.println("<li><a href='../../admin/members?cpage="+i+"'>"+i+"</a></span>");
      }
   }
