...
//그럴라고
    	...
    	ArrayList<TeamTO> memberLists = pageAdminTeamTO.getTeamLists();
    ...
    <nav id="header">
        <div id="headerWap">
            <h1 id="logoSec">
             ...
             <h3><%=welcome %><a href="logoutok.do" id="logout" style="color : gay"> <br/><%=log %>	</a></h3>
      ...
      <section id="locationSec">
        <div id = "locationwrap">
             ...
             <button class="active"><a href="adminteam.do" style="color: #de5f47">소모임 목록</a></button>
...
<%	
	...
	if (cpage==1) { //<
		...
		out.println("<span><a href='adminteam.do?cpage="+(cpage-1)+"'>&lt;</a>&nbsp;&nbsp;</span>");
	}
	...
	for (int i=startBlock;i<=endBlock;i++) {
		if (cpage==i) {
			...
			out.println("<li><a href='adminteam.do?cpage="+i+"'>"+i+"</a></span>");
		}
	}
