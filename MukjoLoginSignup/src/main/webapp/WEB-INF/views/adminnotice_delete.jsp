	...
	<div id="wrap">
		<div class="con_txt">
			...
			<input type="hidden" name="seq" value="" />
				...
				<tr>
					<th>제목</th>
					<td colspan="3"><input type="text" name="subject" value="여기에 제목" class="board_view_input" readonly/></td>
				</tr>
				<tr>
					<th>비밀번호</th>
					<td colspan="3"><input type="password" name="password1" value="" maxlength="15" class="board_view_input"/></td>
				</tr>
				
				<tr>
					<th>비밀번호 재확인</th>
					<td colspan="3"><input type="password" name="password2" value="" maxlength="15" class="board_view_input"/></td>
				</tr>
				</table>
			</div>
			...
			<div class="btn_area">
				<div class="align_left">
					<input type="button" value="목록" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='adminnotice.do'" />
					<input type="button" value="보기" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='adminnotice_view.do'" />
				</div>
...
<script>
    $("#dbtn").click(function () {
        Swal.fire({
          ...
          confirmButtonColor: '#f1b654',
          cancelButtonColor: '#5c3018',
