          ...
          for (int i = j ; i < j+20 ; i++) {
             ...
             if (i < memberLists.size()) {
                ...
                sbHtml.append( "<td>" + birth + "</td>" );
               	sbHtml.append( "<td><a href='./bossacceptyes.do?seq="+seq+"&name="+name+"&tseq="+tseq+"'><button type='sumbit'>승인</button></a>" );
                sbHtml.append( "&nbsp&nbsp<a href='./bossacceptno.do?seq="+seq+"&name="+name+"&tseq="+tseq+"'><button type='sumbit'>거절</button></a></td>" );
                sbHtml.append( "</tr>" );
                num+=1;
    ...
    <nav id="header">
        ...
        <div id="headerWap">
            ...
            <ul>
                ...
                <li><b><a href="boss.do" style="color : #de5f47;">소모임장페이지</a></b></li>
      ...
      <section id="locationSec">
        <div id = "locationwrap">
            <button class="allbtn" ><a href="bossmember.do?tseq=<%=tseq %>" >멤버 관리</a></button>
             <button class="active"><a href="bossaccept.do?tseq=<%=tseq %>" style="color: #de5f47">가입 요청</a></button>
                    ...
                    <%=sbHtml.toString() %>
                      <!--  
                        <tr>
                            ...
                            <td><a href="#">이다함</a></td>
                            <td><a href="#">
                               </button><button type="sumbit">승인</button>
                               </button><button type="sumbit">추방</button>
                            </a>
                            </td>
                        </tr>
