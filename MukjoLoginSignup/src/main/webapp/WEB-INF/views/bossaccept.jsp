      ...
      <section id="locationSec">
        <div id = "locationwrap">
            <button class="allbtn" ><a href="../../adgroups/members?tseq=<%=tseq %>" >멤버 관리</a></button>
             <button class="active"><a href="../../adgroups/request?tseq=<%=tseq %>" style="color: #de5f47">가입 요청</a></button>
...
<%   
   if (startBlock==1) { //<<
      ...
      out.println("<span><a href='../../adgroups/request?cpage="+(startBlock-blockPerPage)+"'>&lt;&lt;</a>&nbsp;&nbsp;</span>");
   }
   ...
   for (int i=startBlock;i<=endBlock;i++) {
      if (cpage==i) {
         ...
         out.println("<li><a href='../../adgroups/request?cpage="+i+"'>"+i+"</a></span>");
      }
   }
